<div id="page-content">	
  ...
  <?php foreach($tampil as $res) {
    ...
    <div class="col-lg-3" style="margin-top: 2%">
      ...
      <div class="panel widget" style="height:250px">
        <div class="widget-header bg-default">
          <img class="widget-bg img-responsive" src="<?php echo base_url ()?>assets/img/<?php echo $res->foto?>" alt="Image">
        </div>
        <div class ="text-center" style="margin-top:15px;">
          ...
          <p class="text-muted mar-no" style="height:20px;">
            <?= substr($res->username,0,35) ?>
          </p>
        </div>
        <div class="pad-all text-center">
         <span>
          <a data-toggle="modal" data-target="#demo-default-modal1<?php echo $res->id_admin?>" class=" btn btn-success btn-sm">
            <span class="fa fa-edit"></span>
            &nbsp;Edit
          </a>
        </span>
        <span>
          <a data-toggle="modal" data-target="#demo-default-modal2<?php echo $res->id_admin?>" class=" btn btn-danger btn-sm">
            <span class="fa fa-trash"></span>
            &nbsp;Hapus
          </a>
          <a data-toggle="modal" data-target="#demo-default-detail<?php echo $res->id_admin?>" class=" btn btn-default btn-sm">
    ...
    <!-- update -->
    <div class="modal fade" id="demo-default-modal1<?php echo $res->id_admin?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <input type="hidden" name="id_admin" value="<?php echo $res->id_admin?>">
          ...
          <div style="margin-top: 30px" class="col-md-6">
            ...
            <input type="password" value="<?= $res->password ?>"  name="password"  placeholder="Password" class="form-control">
          </div>
          <div style="margin-top: 30px" class="col-md-6" >
    ...
    <!-- detail -->
    <div class="modal fade" id="demo-default-detail<?php echo $res->id_admin?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
  ...
  <!-- hapus -->
  <div class="modal fade" id="demo-default-modal2<?php echo $res->id_admin?>" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
